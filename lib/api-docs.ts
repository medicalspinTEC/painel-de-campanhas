...
export const API_DOCS: Record<string, EndpointDoc> = {
  ...
  "POST /api/leads": {
    ...
    bodyFields: [
      ...
      { nome: "produto", tipo: "enum", descricao: `Opcional. Se enviado, um de: ${ENUMS.produto}.` },
      { nome: "marca", tipo: "enum", descricao: `Opcional. Se enviado, um de: ${ENUMS.marca}.` },
      { nome: "persona", tipo: "enum", descricao: `Opcional. Se enviado, um de: ${ENUMS.persona}.` },
      { nome: "regiao", tipo: "enum", descricao: `Opcional. Se enviado, um de: ${ENUMS.regiao}.` },
